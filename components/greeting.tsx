...
const greetings = [
  'Hello..', 'Bonjour..', 'Hola..', 'Ciao..', 'Hallo..', 'Salam..', 'Niaje..',
]
...
export default function Greeting() {
  ...
  return (
    <div className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-600">
      {displayGreeting}
